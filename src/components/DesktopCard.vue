<template>
    ...
    <div class="port-card q-mx-xl flex row">
        <div class="col-7 text-yellow">
            <video src="/app-lista-compras.mp4" loop muted autoplay></video>
        </div>
        <div class="col-5 montserrat-font text-center text-yellow">
            <div class="q-ma-lg text-h6">
                App Lista de compras
            </div>
            <div class="text-subtitle1">
                Aplicación Vue/Android
            </div>
            <br>
            <div class="text-body1 text-justify q-mx-sm">
                Aplicación híbrida, realizada con el framework QuasarJS que está basado en VueJS.
            </div>
        </div>
    </div>
