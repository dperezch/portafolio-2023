  ...
  <div class=" flex justify-center">
    <div style="max-width: 90%; width: 600px;">
      <q-intersection
        transition="rotate"
        class="example-item"
        v-for="list in skillStore.list" :key="list.index"
      >
        <q-item v-ripple class="montserrat-font">
          <q-item-section avatar>
            <q-avatar color="teal-6" text-color="white">
              {{ list.letra }}
            </q-avatar>
          </q-item-section>
          ...
          <q-item-section :class="$q.dark.isActive? 'text-black': 'text-white' ">
            ...
            <q-item-label caption lines="5" > {{ list.label }} </q-item-label>
          </q-item-section>
