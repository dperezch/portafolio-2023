<template>
    <div>
        ...
        <svg height="8.4666mm"
            :style="`fill:${colorFill}`"  style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd;"
